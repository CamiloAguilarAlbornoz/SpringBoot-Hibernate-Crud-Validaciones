package com.camilo.curso.springboot.app.security.filter;
...
import static com.camilo.curso.springboot.app.security.TokenJwtConfig.*;
...
public class JwtAthenticationFilter extends UsernamePasswordAuthenticationFilter {
	...
	public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
		...
		// conversión del JSON que llega del front a un entity User
		User user = null;
		String username = null;
		String password = null;
		try {
			user = new ObjectMapper().readValue(
					request.getInputStream(), // Captura el Json que llega del frontend 
					User.class); // Indica la entidad a la que lo va a convertir
